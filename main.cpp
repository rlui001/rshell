...
int main()
{
    bool andState = false;
    bool orState = false;
    bool semiState = false;

    // vectors to store commands and symbols
    ...
    while (1)
    {
        ...
        string copy = userinput; // create copy of user input to modify
        
        // token to take all relevant connectors into vector
